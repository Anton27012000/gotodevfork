...
// Есть поток данных в виде идентификаторов отелей (hotelIDs), для каждого
// отеля нужно:
...
func main() {
	...
	// Код здесь. Остальные функции и их сигнатуры менять нельзя. Допускается
	// использовать функции-обертки.
}
